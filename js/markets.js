...
function loadMarketTable() {
    ...
    if (currentFilter !== 'all') {
        filteredData = filteredData.filter(crypto => {
            if (currentFilter === 'large') return crypto.category === 'large';
            if (currentFilter === 'mid') return crypto.category === 'mid';
            if (currentFilter === 'defi') return crypto.category === 'defi';
            if (currentFilter === 'meme') return crypto.category === 'meme';
            return true;
        });
    }
    ...
    tbody.innerHTML = filteredData.map(crypto => {
        ...
        return `
            <tr onclick="goToTrade('${crypto.symbol}')">
                ...
                <td>
                    <button class="btn-details" onclick="event.stopPropagation(); goToTrade('${crypto.symbol}')">
                        Trade ${crypto.symbol}
                    </button>
                </td>
            </tr>
